...
public class TrustAllSSLSocketFactory implements LayeredSocketFactory {
    ...
    public TrustAllSSLSocketFactory(final KeyStore keystore, final String keystorePassword) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
        this(TLS, keystore, keystorePassword, null, null, null);
    }

    public TrustAllSSLSocketFactory(final KeyStore truststore) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
    ...
    public TrustAllSSLSocketFactory(javax.net.ssl.SSLSocketFactory socketfactory) {
        super();
