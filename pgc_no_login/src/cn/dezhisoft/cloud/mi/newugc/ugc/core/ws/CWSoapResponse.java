 ...
 * 
 */
public class CWSoapResponse implements IRequestListener ,Cloneable {
	...
	public CWSoapResponse(){
		this(SoapRequestMode.MODE_BACKGROUND,null);
	}
	
	public CWSoapResponse(Handler handler){
		this(SoapRequestMode.MODE_FOREGROUND,handler);
	}
	
	public CWSoapResponse(CWSoapResponse response){
		this(response.mode,response.handler);
	}
	
	public CWSoapResponse(int mode, Handler handler){
		this.mode 	  = mode ;
		this.handler  = handler ;
	}
	
	public final void init(CWSoapResponse response){
