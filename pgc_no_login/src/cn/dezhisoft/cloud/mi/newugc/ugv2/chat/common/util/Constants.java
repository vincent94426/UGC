package cn.dezhisoft.cloud.mi.newugc.ugv2.chat.common.util;

public class Constants {
	public static final String SERVER_IP = "192.168.81.111";// 服务器ip
	...
	public static final String DBNAME = "qq3.db";//数据库名称
}
